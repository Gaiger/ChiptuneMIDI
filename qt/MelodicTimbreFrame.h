...
private slots:
	...
	void on_NoteOffHoldSustainTimeDoubleSpinBox_valueChanged(double value);
	void on_NoteOffHoldSustainCurveComboBox_currentIndexChanged(int index);
	void on_NoteOffHoldSustainLevelSpinBox_valueChanged(int value);
private :
