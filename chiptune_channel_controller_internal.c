...
#define DEFAULT_ENVELOPE_ATTACK_CURVE				(EnvelopeCurveLinear)
#define DEFAULT_ENVELOPE_ATTACK_DURATION_IN_SECOND	(0.02f)
#define DEFAULT_ENVELOPE_DECAY_CURVE				(EnvelopeCurveFermi)
...
#define DEFAULT_ENVELOPE_NOTE_OFF_HOLD_SUSTAIN_DURATION_IN_SECOND (8.0f)
	...
	if(false == is_instrument_to_be_not_specified){
		instrument_code = AcousticGrandPiano;
	}
	p_channel_controller->instrument_code = instrument_code;
...
#define DEFAULT_PERCUSSION_RELEASE_TIME_SECONDS		(0.005f)
	...
	p_channel_controller->instrument_code = CHANNEL_CONTROLLER_INSTRUMENT_NOT_SPECIFIED;
	p_channel_controller->is_output_enabled = true;
...
static void reset_percussion_timbre_from_index(int8_t const percussion_key)
{
	...
	case BassDrum1:
		...
		break;
	case SideStick:
		start_frequency = 1250;
		end_frequency = 620;
		total_druation_time_in_second = 0.06f;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.003f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformTriangle;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.010f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise;
		p_percussion->is_implemented = true;
		break;
	case AcousticSnare:
	...
	case ChineseCymbal:
		...
		end_frequency = 7300;
		total_druation_time_in_second = 1.0f;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.02f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformTriangle;
		...
		break;
	case RideBell:
		start_frequency = 8300;
		end_frequency = 8400;
		total_druation_time_in_second = 0.65f;
	...
	case Tambourine:
		...
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.05f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformTriangle;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.10f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise;
		p_percussion->is_implemented = true;
		break;
	case SplashCymbal:
	...
	case Cowbell:
		...
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.01f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformTriangle;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.22f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise;
		p_percussion->is_implemented = true;
		break;
	case Vibraslap:
		start_frequency = 200;
		end_frequency   = 100;
		total_druation_time_in_second = 1.40f;
		//p_percussion->p_amplitude_envelope_table = s_linear_decline_table;
		...
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.015f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformSquare;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.90f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise; p_percussion->is_implemented = true;
		break;
	case HighBongo:
		start_frequency = 260;
		end_frequency   = 340;
	...
	case LowWoodBlock:
		...
		*/
		...
		break;
	case MuteTriangle:
		start_frequency = 3800;
		end_frequency = 4000;
		total_druation_time_in_second = 0.2f;
		p_percussion->p_phase_sweep_table = s_fermi_decline_table;
		p_percussion->waveform[last_waveform_segment_index] = WaveformTriangle;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.1f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise;
		p_percussion->is_implemented = true;
		break;
	case OpenTriangle:
		...
		p_percussion->p_phase_sweep_table = s_fermi_decline_table;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.001f; last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformTriangle;
		p_percussion->is_implemented = true;
		break;
	/*GM2*/
	...
	case Shaker:
		...
		break;
	case JingleBell:
		start_frequency = 5400;
		end_frequency   = 5500;
		total_druation_time_in_second = 0.30f;
		p_percussion->p_phase_sweep_table = s_exponential_growth_table;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.01f;
		last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformTriangle;
		waveform_duration_time_in_second[last_waveform_segment_index] = 0.18f;
		last_waveform_segment_index += 1;
		p_percussion->waveform[last_waveform_segment_index] = WaveformNoise;
		p_percussion->is_implemented = true;
		break;
