...
#define SUSTAIN_AMPLITUDE(LOUDNESS, SUSTAIN_LEVEL)	\
	SCALE_BY_LEVEL((LOUDNESS), (SUSTAIN_LEVEL))

#define MELODIC_ENVELOPE_DELTA_AMPLITUDE(AMPLITUDE, TABLE_VALUE) \
	SCALE_BY_LEVEL((AMPLITUDE), (TABLE_VALUE))

#define PERCUSSION_PHASE_SWEEP_DELTA(MAX_PHASE_SWEEP_DELTA, SWEEP_TABLE_VALUE) \
	SCALE_BY_LEVEL((MAX_PHASE_SWEEP_DELTA), (SWEEP_TABLE_VALUE))
